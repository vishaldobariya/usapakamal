  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <a class="nav-link" href="">Mobile Slider</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= Url::toRoute(['/settings/banner/middle-images']) ?>">Middle Images</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= Url::toRoute(['/settings/banner/footer-images']) ?>">Footer Images</a>
      </li>
    </ul>
  </div>
</nav>
	<div class="card-body">
			...
			<?= Upload::widget([
				...
				'files'               => $files,
				'hiddenInputId'       => true,
				'url'                 => ['/storage/default/upload-mobile-slider'],
				'uploadPath'          => 'slider/',
				'sortable'            => true,
				'maxNumberOfFiles'    => 10,
				...
				'clientOptions'       => [
					...
					$.post({
					url:"/settings/banner/mobile-get-id",
...
$(document).on('change','.js-change',function(){
  ...
  let val = $(this).val()
   ...
   data:{id:id,val:val,model_name:'Slider'}
   })
})
